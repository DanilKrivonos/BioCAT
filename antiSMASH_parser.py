            ...
            for key in open_js['records']:
                for i in key['features']:
                    ...
                    if 'CDS' in i['type']:
                        ...
                        check_tag = i['qualifiers']['locus_tag'][0]

                        if check_tag not in coord_tag:

                            coord_tag[check_tag] = {}
                            coord_tag[check_tag] = i['location']
                    ...
                    #     if tag in knw_i['cds_name']:
                        ...
                        #        coordinate_protocluster = knw[0]['location']
                        #       coordinate_core = knw[0]['qualifiers']['core_location']
                        #      BGC = 'BGC_{}'.format(knw[0]['qualifiers']['protocluster_number'][0])
